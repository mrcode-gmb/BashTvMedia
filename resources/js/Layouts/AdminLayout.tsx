...
function LayoutContent({ children, header }: AdminLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(5,129,247,0.10),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(4,201,252,0.08),transparent_22%),#f8fafc] text-foreground dark:bg-[radial-gradient(circle_at_top_left,rgba(5,129,247,0.10),transparent_18%),radial-gradient(circle_at_bottom_right,rgba(4,201,252,0.08),transparent_18%),#020617]">
                    ...
                    <header className="sticky top-0 z-40 bg-white/[0.88] backdrop-blur dark:bg-slate-950/[0.82]">
                        <div className="flex items-center gap-3 px-4 py-4 lg:px-6">
                            ...
                            <div className="ml-auto flex items-center gap-2">
                                <Link
                                    href={route('welcome')}
                                    className="hidden items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-[hsl(var(--BashTv-navy))] transition hover:text-accent dark:bg-slate-900 dark:text-white sm:inline-flex"
                                >
                                    View Site
                                    <ArrowUpRight className="h-4 w-4" />
                                </Link>
